...
class Login(unittest.TestCase):
    ...
    def setUp(self):
        self.driver = webdriver.Chrome('C:/Users/aarya/Downloads/chromedriver_win32 (2)/chromedriver.exe', options=chromeOptions)
    ...
    def test_login(self):
        ...
        password.send_keys("aaryan.purohit")
...
class Portfolio(unittest.TestCase):
    ...
    def test_portfolio(self):
        ...
        # WebDriverWait(driver, 5).until(EC.presence_of_element_located((By.XPATH, '/html/body/div[1]/div/div/div/div/div[4]/div/div/div/div[1]/div/div/div[2]/form/div[5]/button')))
        ...
        WebDriverWait(driver, 60).until(EC.alert_is_present(),
                                   'Stock Holding successfully added to your portfolio')
